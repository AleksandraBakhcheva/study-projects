        ...
        (function (global, factory) {
          ...
          function _elementsEqual(a0, a1) {
            ...
            for (i = 0, ilen = a0.length; i < ilen; ++i) {
              ...
              v1 = a1[i];
              if (
                v0.datasetIndex !== v1.datasetIndex ||
                v0.index !== v1.index
              ) {
                return false;
              }
          ...
          function isValidKey(key) {
            return (
              ["__proto__", "prototype", "constructor"].indexOf(key) === -1
            );
          }
          ...
          function calln(f, a, b, c) {
            return (Array.isArray(a) ? f(a[0], a[1], a[2]) : f(a, b, c)).map(
              n2b
            );
          }
          ...
          function getMaximumSize(canvas, bbWidth, bbHeight, aspectRatio) {
            ...
            const maxHeight =
              parseMaxStyle(style.maxHeight, canvas, "clientHeight") ||
              INFINITY;
          ...
          function _descriptors(
            ...
            return {
              ...
              isScriptable: isFunction(_scriptable)
                ? _scriptable
                : () => _scriptable,
              isIndexable: isFunction(_indexable)
                ? _indexable
                : () => _indexable,
            };
          }
          ...
          function styleChanged(style, prevStyle) {
            return (
              prevStyle && JSON.stringify(style) !== JSON.stringify(prevStyle)
            );
          }
          ...
          function buildLayoutBoxes(boxes) {
            ...
            const top = sortByWeight(
              filterByPosition(layoutBoxes, "top"),
              true
            );
            const bottom = sortByWeight(
              filterByPosition(layoutBoxes, "bottom")
            );
            const centerHorizontal = filterDynamicPositionByAxis(
              layoutBoxes,
              "x"
            );
            const centerVertical = filterDynamicPositionByAxis(
              layoutBoxes,
              "y"
            );
            return {
          ...
          function isStacked(scale, meta) {
            ...
            return (
              stacked || (stacked === undefined && meta.stack !== undefined)
            );
          }
          function getStackKey(indexScale, valueScale, meta) {
            return `${
              indexScale.id
            }.${valueScale.id}.${meta.stack || meta.type}`;
          }
          ...
          function autoSkip(scale, ticks) {
            ...
            const ticksLimit =
              tickOpts.maxTicksLimit || determineMaxTicks(scale);
          ...
          class Scale extends Element {
            ...
            isHorizontal() {
              ...
              return (
                position === "top" || position === "bottom" || axis === "x"
              );
            }
            isFullSize() {
            ...
            drawBorder() {
              ...
              const lastLineWidth = grid.setContext(
                this.getContext(0)
              ).lineWidth;
            ...
            _resolveTickFontOptions(index) {
              const opts = this.options.ticks.setContext(
          ...
          class PluginService {
            ...
            _notifyStateChanges(chart) {
              ...
              this._notify(
                diff(previousDescriptors, descriptors),
                chart,
                "stop"
              );
              this._notify(
          ...
          function mergeScaleConfig(config, options) {
            ...
            config.data.datasets.forEach((dataset) => {
              ...
              const indexAxis =
                dataset.indexAxis || getIndexAxis(type, options);
          ...
          class Chart {
            ...
            _resize(width, height) {
              ...
              const aspectRatio =
                options.maintainAspectRatio && this.aspectRatio;
          ...
          function setBorderSkipped(properties, options, stack, index) {
            ...
            const { start, end, reverse, top, bottom } =
          ...
          function pathArc(ctx, element, offset, spacing, end, circular) {
            ...
            if (circular) {
              ...
              const outerEndX =
                Math.cos(outerEndAdjustedAngle) * outerRadius + x;
              const outerEndY =
                Math.sin(outerEndAdjustedAngle) * outerRadius + y;
          ...
          function setStyle(ctx, options, style = options) {
            ...
            ctx.setLineDash(
              valueOrDefault(style.borderDash, options.borderDash)
            );
          ...
          function pathVars(points, segment, params = {}) {
            const count = points.length;
            const { start: paramsStart = 0, end: paramsEnd = count - 1 } =
              params;
          ...
          class Legend extends Element {
            ...
            drawTitle() {
              ...
              const topPaddingPlusHalfFontSize =
                titlePadding.top + halfFontSize;
              let y;
              let left = this.left;
          ...
          function generateTicks(generationOptions, dataRange) {
            ...
            const endSignificand = Math.ceil(
          ...
          class LogarithmicScale extends Scale {
            ...
            getValueForPixel(pixel) {
              ...
              return Math.pow(
                10,
                this._startValue + decimal * this._valueRange
              );
            }
          }
          ...
          class RadialLinearScale extends LinearScaleBase {
            ...
            getPointPosition(index, distanceFromCenter, additionalAngle = 0) {
              const angle =
                this.getIndexAngle(index) - HALF_PI + additionalAngle;
              return {
